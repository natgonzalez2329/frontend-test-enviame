...
const ModalEdit = ({ characters, setCharacters, character, setNameModified, nameModified, setDescriptionModified, descriptionModified, setId, id }) => {
            ...
            <div className="d-flex justify-content-end">
              ...
              <form>
                ...
                <div className="mb-3 text-start">
                  ...
                  />
                  <textarea className="form-control bg-dark text-white border border-secondary" id="recipient-name" value={descriptionModified}></textarea>
                </div>
                <div className="d-flex justify-content-end">
              <button
                type="button"
