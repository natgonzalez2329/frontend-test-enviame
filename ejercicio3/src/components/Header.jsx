...
const Header = ({ searchName, setSearchName, data }) => {
  
  /*   const charactersFilter = (characterName) => {
       const nameResult = charactersData.filter((nameData) => {
          if (nameData.name.toString().toLowerCase().includes(characterName.toLowerCase())) {
              return nameData;
          }
        });
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form className="d-flex" onSubmit={(e) => handleSubmitSearch(e)}>
              <div className="input-group">
                ...
                />
                <button
                  className="header__search-button d-flex justify-content-center align-items-center"
                  type="submit"
                >
                  <svg
